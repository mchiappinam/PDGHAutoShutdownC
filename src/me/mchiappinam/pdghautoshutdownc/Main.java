package me.mchiappinam.pdghautoshutdownc;
...
public class Main extends JavaPlugin implements Listener {
	...
	public void onDisable() {
		getServer().getConsoleSender().sendMessage("§3[PDGHAutoShutdownC] §2desativado - Plugin by: mchiappinam");
		getServer().getConsoleSender().sendMessage("§3[PDGHAutoShutdownC] §2Acesse: http://pdgh.com.br/");
	}
    ...
    public void onEnable() {
		...
		getServer().getConsoleSender().sendMessage("§3[PDGHAutoShutdownC] §2ativado - Plugin by: mchiappinam");
		getServer().getConsoleSender().sendMessage("§3[PDGHAutoShutdownC] §2Acesse: http://pdgh.com.br/");
	}
